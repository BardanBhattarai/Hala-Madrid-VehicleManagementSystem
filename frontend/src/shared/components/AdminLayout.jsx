      ...
      <div className="w-72 bg-white border-r border-slate-200 shadow-sm flex flex-col">
        <div className="p-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-black text-indigo-600 uppercase tracking-wider">Admin Portal</p>
          </div>
        </div>

        <nav className="flex-1 mt-2 overflow-y-auto">
          <div className="px-6 py-2 text-[10px] font-black text-slate-400 uppercase tracking-widest">Management</div>
          <SidebarLink 
            to="/admin/reports" 
          ...
          <SidebarLink 
            ...
            active={location.pathname.includes('/purchase-invoices')} 
          />
        </nav>
